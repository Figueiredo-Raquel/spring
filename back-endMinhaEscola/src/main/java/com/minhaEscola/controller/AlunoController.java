...
public class AlunoController {
	...
	@Autowired //ele vai instanciar, e acessar todos os servicos do repository.
	...
	@PostMapping //ele posta
	public ResponseEntity<AlunoModel> post (@RequestBody AlunoModel alunoModel){
		return ResponseEntity.status(HttpStatus.CREATED).body(repository.save(alunoModel));
	}
	
	@PutMapping //ele edita
	public ResponseEntity<AlunoModel> put (@RequestBody AlunoModel alunoModel){
